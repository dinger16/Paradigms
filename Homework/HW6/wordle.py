...
if win:
    print("Congratulations, you correctly identified the word after {} attempts".format(tries+1))
else:
    print("The answer is {}. You did not correctly guess it within 6 tries.".format(answer))